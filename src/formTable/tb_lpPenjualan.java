 ...
 * @author ASUS
 */
public class tb_lpPenjualan extends javax.swing.JInternalFrame {

    /**
     * Creates new form tb_lpPenjualan
     */
    ...
    public void tampilkan() {
        try {
            ...
            String awal = String.valueOf(sdf.format(jDateAwal.getDate()));
            String akhir = String.valueOf(sdf.format(jDateAkhir.getDate()));
            DefaultTableModel tableModel = new DefaultTableModel();
            String sql = "SELECT * FROM tb_penjualan where tanggal between '"+java.sql.Date.valueOf(awal)+"' and '"+java.sql.Date.valueOf(akhir)+"'";
            tableModel = koneksi_database.Tool.dataModeler(sql,alamatIP.getIp());
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Laporan Penjualan Barang"));
        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jDateAwal, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
