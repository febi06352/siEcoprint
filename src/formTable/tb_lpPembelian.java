 ...
 * @author ASUS
 */
public class tb_lpPembelian extends javax.swing.JInternalFrame {
    ...
    public void tampilkan() {
        try {
            ...
            String sql = "SELECT * FROM tb_pembelian where tanggal between '"+java.sql.Date.valueOf(awal)+"' and '"+java.sql.Date.valueOf(akhir)+"'";
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Laporan Pembelian Barang"));
        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
